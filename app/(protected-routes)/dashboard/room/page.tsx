    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Welcome back! Here's your StudyPair overview.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all cursor-pointer">
          <CardContent className="p-4" onClick={handleCreateVideoRoom}>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Connect face-to-face with your study partners using our built-in
          ...
          <CardContent className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                High-quality, peer-to-peer video calls with no external software
                required. Create rooms instantly or join existing sessions.
              </p>

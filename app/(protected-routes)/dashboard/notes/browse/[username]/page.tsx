...
async function getUserByUsername(
  ...
  const { data: profile, error } = await supabase
    ...
    .eq("visibility", "public") // Only show public profiles
    .single();
...
async function getUserNotes(
  ...
  const transformedNotes = (notesData || []).map((note: any) => ({
    ...
    thumbnailUrl: note.file_url ? `${note.file_url}?thumbnail=true` : undefined,
  ...
  return (
    <div className="container mx-auto space-y-6">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <div className="flex gap-6 text-sm">
                <div className="text-center">
                  <div className="font-semibold">{stats.totalPublicNotes}</div>
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Follow Button - TODO: Implement follow functionality */}
      ...
      {notes.length > 0 ? (
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">No public notes yet</h3>
            <p className="text-muted-foreground">
